...
$create_table = "CREATE TABLE IF NOT EXISTS nanodb (ID INT AUTO_INCREMENT, login varchar(255), password varchar(255), addr varchar(255) NOT NULL, port varchar(255) NOT NULL, path varchar(255), location varchar(255), PRIMARY KEY (ID))";
...
if ($addr != "" && $path != "" && $port != "")
{
  	$query = "INSERT INTO nanodb (login, password, addr, port, path, location) VALUES('$login', '$pass', '$addr', '$port', '$path', '$key')";
	echo "ok";
